...
This folder contains curated links to external resources for AZ-305 exam preparation.
...
- [Azure Solutions Architect Certification](https://learn.microsoft.com/en-us/certifications/azure-solutions-architect/)

### Microsoft Learn
- [AZ-305 Learning Path](https://learn.microsoft.com/en-us/training/browse/?products=azure&roles=solution-architect)
...
- [Udemy - AZ-305 Courses](https://www.udemy.com/)
...
- [Microsoft Official Practice Assessment](https://learn.microsoft.com/en-us/certifications/exams/az-305)
...
- [Azure Sandbox](https://learn.microsoft.com/en-us/training/)
...
- [TechCommunity Forums](https://techcommunity.microsoft.com/t5/azure/ct-p/Azure)

### Blogs
- [Azure Tips and Tricks](https://microsoft.github.io/AzureTipsAndTricks/)
- [Thomas Maurer Blog](https://www.thomasmaurer.ch/)
...
- Subscribe to Azure Updates for latest features
- Join Azure webinars and virtual events
- Practice with hands-on labs regularly
- Join study groups or find a study buddy
- Create your own diagrams and architectures

---

**Note**: Links and resources are regularly updated. Always verify with official Microsoft documentation for the most current information.
